  ...
  return (
    <div className="flex flex-col font-[mainfont] md:flex-row items-center justify-between w-full max-w-7xl mx-auto px-4 py-20">
      ...
      <div className="flex flex-col space-y-4 md:w-1/2 text-center md:text-left">
        ...
        <TextAnimator>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-orange-500 leading-tight">
            SCALABLE
          </h2>
        </TextAnimator>
        <TextAnimator>
        ...
        <TextAnimator>
          <p className="text-sm md:text-base text-gray-600 mt-4">
            We at The Alpha Team believe that innovative use of technology
            combined with creative designs and use of basic principles of
            marketing produces out of the box and effective solutions. We help
            you stay ahead of the competition by adopting new tools, techniques
            and capabilities coming in to the digital marketing world everyday.
          </p>
        </TextAnimator>
        <TextAnimator>
          <p className="text-sm md:text-base text-gray-600">
      ...
      <div
        ref={rocketRef}
        className="flex flex-col items-center md:w-1/2 mt-10 md:mt-0"
      >
        <img
          // ref={rocketRef}
          src="images/view-3d-space-rocket-model-1.png"
